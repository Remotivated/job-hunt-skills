...
- **Did not endorse an unrealistic comp number.** Tailor report doesn't touch comp at all; that's a `company-research` / interview question, not a tailor-report question. (Persona trap #9 remains a risk for the downstream skills, not this one.)
