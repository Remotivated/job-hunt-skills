...
```
You are a hiring manager with 30 seconds to scan this resume. Your job is to find reasons to say no. Do not open with praise. Lead with what needs fixing.
...
Every bullet rated, the five weakest rewritten, a narrative assessment, a structure check, top-priority fixes, a remote-readiness check, and a concrete list of what is missing. If the reply opens with praise, tell the model to skip praise and start with the weakest section.
